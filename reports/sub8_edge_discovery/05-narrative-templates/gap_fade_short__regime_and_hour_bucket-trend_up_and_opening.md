# Narrative Gate — gap_fade_short__regime+hour_bucket=trend_up+opening

## Setup
`gap_fade_short`

## Conditional rule
regime+hour_bucket = trend_up+opening
...
This setup passes statistical gates in the cell `regime+hour_bucket = trend_up+opening`. Candidate

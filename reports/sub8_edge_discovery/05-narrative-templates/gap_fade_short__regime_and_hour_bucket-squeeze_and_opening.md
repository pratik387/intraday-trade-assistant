# Narrative Gate — gap_fade_short__regime+hour_bucket=squeeze+opening

## Setup
`gap_fade_short`

## Conditional rule
regime+hour_bucket = squeeze+opening
...
This setup passes statistical gates in the cell `regime+hour_bucket = squeeze+opening`. Candidate
...
Identical trade set (opening hour == full setup window; cap mostly small_cap).
